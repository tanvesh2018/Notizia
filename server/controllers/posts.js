...
export const getPosts = async (req, res) => {
    ...
    try {
        //limiting number of posts per page to 8
        const LIMIT = 8;
...
export const getPostsBySearch = async (req, res) => {
    ...
    try {
        //for performing case sensitive matching 'i' is used
        const title = new RegExp(searchQuery, "i");

        //finding the message and returning it 
...
export const createPost = async (req, res) => {
    ...
    //creating a new object for the post
...
export const updatePost = async (req, res) => {
    ...
    //treats updated post as new post
